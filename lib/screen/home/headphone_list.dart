...
import 'package:gaming_shop_app_ui/screen/detail/detail_screen_headphone.dart';
import 'package:svg_flutter/svg.dart';

class HeadphoneList extends StatefulWidget {
  const HeadphoneList({super.key});
...
class _HeadphoneListState extends State<HeadphoneList> {
  ...
  GestureDetector gamingItems(int index) {
    ...
    final game = headphoneList[index];
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => DetailScreenHeadphone(game: game),
          ),
        );
        if (currentSelectItems == index) {
        } else {
