...
import 'package:gaming_shop_app_ui/screen/detail/details_screen_vr.dart';
import 'package:svg_flutter/svg.dart';

class VrProductsList extends StatefulWidget {
  const VrProductsList({super.key});

  @override
  State<VrProductsList> createState() => _VrProductsListState();
}

class _VrProductsListState extends State<VrProductsList> {
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => DetailScreenVr(game: game),
          ),
        );
        if (currentSelectItems == index) {
        } else {
